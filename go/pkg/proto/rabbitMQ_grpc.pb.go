...
const (
	...
	RabbitMQ_SendMicroserviceCommStream_FullMethodName  = "/dynamos.RabbitMQ/SendMicroserviceCommStream"
...
type RabbitMQClient interface {
	...
	SendMicroserviceCommStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MicroserviceCommunicationChunk, emptypb.Empty], error)
...
func (c *rabbitMQClient) SendMicroserviceCommStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MicroserviceCommunicationChunk, emptypb.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RabbitMQ_ServiceDesc.Streams[2], RabbitMQ_SendMicroserviceCommStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MicroserviceCommunicationChunk, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RabbitMQ_SendMicroserviceCommStreamClient = grpc.ClientStreamingClient[MicroserviceCommunicationChunk, emptypb.Empty]
...
type RabbitMQServer interface {
	...
	SendMicroserviceCommStream(grpc.ClientStreamingServer[MicroserviceCommunicationChunk, emptypb.Empty]) error
...
func (UnimplementedRabbitMQServer) SendMicroserviceCommStream(grpc.ClientStreamingServer[MicroserviceCommunicationChunk, emptypb.Empty]) error {
	return status.Errorf(codes.Unimplemented, "method SendMicroserviceCommStream not implemented")
}
...
func _RabbitMQ_SendMicroserviceCommStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RabbitMQServer).SendMicroserviceCommStream(&grpc.GenericServerStream[MicroserviceCommunicationChunk, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RabbitMQ_SendMicroserviceCommStreamServer = grpc.ClientStreamingServer[MicroserviceCommunicationChunk, emptypb.Empty]
...
var RabbitMQ_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SendMicroserviceCommStream",
			Handler:       _RabbitMQ_SendMicroserviceCommStream_Handler,
			ClientStreams: true,
		},
	},
